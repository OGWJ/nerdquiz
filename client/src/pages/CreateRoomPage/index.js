  ...
  return (
    <div className='p-nav w-100 d-flex justify-content-center'>
      <form name='create-room-form' onSubmit={{ createRoomHandler }}>
        ...
        <select id="select-difficulty" className='form-select my-4 text-center' style={{ backgroundColor: selectDifficultyColor }}>
          <option value="EASY">Easy</option>
          <option value="MEDIUM">Medium</option>
          <option value="HARD">Hard</option>
        </select>
        <button type='submit' className='btn btn-success'>Create the Room!</button>
      </form>
    </div>
  );
};
